...
<!--TODO: 
- Maybe mention that in Turing you could also define the conditionals for Gibbs
sampling.
- Mention Turing flexibility.
- Mention performance of Turing.
-->

### Timings
<!--TODO: explain the servers used.-->
<!--TODO: explain that these are one-off timings. Could use the minimums? .-->
Here are the inference times (in seconds) for each PPL for this model.
Smaller is better.
